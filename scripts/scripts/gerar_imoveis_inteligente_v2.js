...
const supabase = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJiaGt3bWVzbXZ5dHFkZnV3Y2llIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk4MTQ0ODUsImV4cCI6MjA4NTM1MDQ1NX0.vHffPyFGC99OhYpfeGihf59oGhIguVwKfQagySAyTck'
);
...
async function gerarImoveisAPartirDeContratos() {
  ...
  try {
    ...
    console.error('[Geracao] Erro fatal:', error);
    return {
      success: false,
      error: error.message,
      gerados: 0,
