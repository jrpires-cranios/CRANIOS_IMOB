...
const imovelTemplates = {
  ...
  'Studio': {
    ...
    area_total: 30,
    area_construida: 28,
    caracteristicas: ['compacto', 'modern'],
  },
  'Sala Comercial': {
    quartos: 0,
    suites: 0,
    ...
    area_total: 48,
    area_construida: 45,
    caracteristicas: ['pronto_para_consorio', 'estacionamento_rotaivo'],
  },
};
...
async function gerarImoveisA partirDeContratos() {
...
async function main() {
  ...
  const resultado = await gerarImoveisA partirDeContratos();
